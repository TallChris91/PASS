...
def ArrangeDatabase(file):
    ...
    windb, tiedb, lossdb = ('Databases/Templates GoalgetterWin.xlsx', 'Databases/Templates GoalgetterTie.xlsx', 'Databases/Templates GoalgetterLoss.xlsx')
    ...
    if homegoals == awaygoals:
        homedb = tiedb
        awaydb = tiedb
    return (homedb, 'home'), (awaydb, 'away')
...
def GeneralTemplates(type, homelegend, hometemplates, awaylegend, awaytemplates):
    ...
    if type == 'title':
        ...
        return possiblelegendhome, possibletemplateshome, possiblelegendaway, possibletemplatesaway
...
def GameCourseTemplates(gamecoursetopic, homelegend, hometemplates, awaylegend, awaytemplates):
    ...
    def TemplateFilter(query1, query2):
        possiblelegendhome = []
        possibletemplateshome = []
        possiblelegendaway = []
        possibletemplatesaway = []
    ...
    if (gamecoursetopic['event'] == 'regular goal') and (gamecoursetopic['team'] == 'home'):
        return TemplateFilter(r'^Game\scourse\,\sregular\sgoal\sfocus\steam', r'^Game\scourse\,\sregular\sgoal\sother\steam')
    ...
    if (gamecoursetopic['event'] == 'regular goal') and (gamecoursetopic['team'] == 'away'):
        return TemplateFilter(r'^Game\scourse\,\sregular\sgoal\sother\steam', r'^Game\scourse\,\sregular\sgoal\sfocus\steam')
    ...
    if (gamecoursetopic['event'] == 'own goal') and (gamecoursetopic['team'] == 'home'):
        return TemplateFilter(r'^Game\scourse\,\sown goal\sfocus\steam', r'^Game\scourse\,\sown goal\sother\steam')
    #Own goals scored by a player of the away team
    if (gamecoursetopic['event'] == 'own goal') and (gamecoursetopic['team'] == 'away'):
        return TemplateFilter(r'^Game\scourse\,\sown goal\sother\steam', r'^Game\scourse\,\sown goal\sfocus\steam')
    ...
    if (gamecoursetopic['event'] == 'penalty goal') and (gamecoursetopic['team'] == 'home'):
        return TemplateFilter(r'^Game\scourse\,\sgoal\sfrom\spenalty\sfocus\steam', r'^Game\scourse\,\sgoal\sfrom\spenalty\sother\steam')
    ...
    if (gamecoursetopic['event'] == 'penalty goal') and (gamecoursetopic['team'] == 'away'):
        return TemplateFilter(r'^Game\scourse\,\sgoal\sfrom\spenalty\sother\steam', r'^Game\scourse\,\sgoal\sfrom\spenalty\sfocus\steam')
    ...
    if (gamecoursetopic['event'] == 'missed penalty') and (gamecoursetopic['team'] == 'home'):
        return TemplateFilter(r'^Game\scourse\,\spenalty\smiss\sfocus\steam', r'^Game\scourse\,\spenalty\smiss\sother\steam')
    ...
    if (gamecoursetopic['event'] == 'missed penalty') and (gamecoursetopic['team'] == 'away'):
        return TemplateFilter(r'^Game\scourse\,\spenalty\smiss\sother\steam', r'^Game\scourse\,\spenalty\smiss\sfocus\steam')

def GameStatisticsTemplates(gamestatisticstopic, homelegend, hometemplates, awaylegend, awaytemplates):
